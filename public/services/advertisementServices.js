...
var AdvertisementFrench = _models["default"].AdvertisementFrench;
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return AdvertisementFrench.findOne({
...
(0, _defineProperty2["default"])(AdvertisementServices, "createAdvertisement", /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(data) {
    var _yield$AdvertisementF, dataValues;
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return AdvertisementFrench.create(_objectSpread(_objectSpread({}, data), {}, {
              createdAt: new Date(),
              updatedAt: new Date()
            }), {
          ...
          case 2:
            _yield$AdvertisementF = _context2.sent;
            dataValues = _yield$AdvertisementF.dataValues;
  ...
  return _regenerator["default"].wrap(function _callee3$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return AdvertisementFrench.findAll();
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return AdvertisementFrench.destroy({
              where: {
                id: id
              }
            });
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return AdvertisementFrench.update({
              title: newData.title,
