...
var NewsFrench = _models["default"].NewsFrench;
...
(0, _defineProperty2["default"])(NewsServices, "createNews", /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(data) {
    var _yield$NewsFrench$cre, dataValues;
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return NewsFrench.create(_objectSpread(_objectSpread({}, data), {}, {
              createdAt: new Date(),
              updatedAt: new Date()
            }), {
          ...
          case 2:
            _yield$NewsFrench$cre = _context2.sent;
            dataValues = _yield$NewsFrench$cre.dataValues;
